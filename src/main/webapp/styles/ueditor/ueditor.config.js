(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'simpleupload', 'insertimage', 'emotion', 'insertvideo', 'music', 'attachment', 'map', 'insertframe', 'pagebreak', 'background', '|',
        ...
        //,'paragraph':{'p':'', 'h1':'', 'h2':'', 'h3':'', 'h4':'', 'h5':'', 'h6':''} //'fxl_text':'font-family: 微软雅黑, &#39;Microsoft YaHei&#39; font-size: 14px;', 
        ...
        //每一个对象就是一个自定义的样式
        ,'customstyle':[
            {tag:'span', name:'', label:'零到壹文本(微软雅黑15px)', style:'font-family: "Microsoft YaHei"; font-size: 15px;'}
        ]
