...
<ul class="nav nav-tabs" id="couponTab">
	...
	<li><a id="couponStatusBtn" href="javascript:;" data-status="40" data-toggle="tab">审核未通过</a></li>
	<li><a id="couponStatusBtn" href="javascript:;" data-status="50" data-toggle="tab">取消审核</a></li>
</ul>
