...
$(document).ready(function () {
	...
	var configTable = $("table#configTable").DataTable({
		...
		"serverSide": true,
		"ajax": {
		    "url": "${ctx}/fxl/app/getTopSearchQuerieList",
		    "type": "POST",
 		    "data": function (data) {
		...
		{	"title" : "ID",
			...
			"title" : '<center>热搜词字典名称</center>',
			"data" : "name",
			"width" : "200px",
			"className": "text-center",
			"orderable" : false
		}, {
			"title" : '<center>热搜词字典编码</center>',
			"data" : "code",
			"width" : "300px",
			"className": "text-center",
			"orderable" : false
		...
		"columnDefs" : [ {
			...
			"render" : function(data, type, full) {
				return '<button id="edit" mId="' + full.DT_RowId + '" type="button" class="btn btn-primary btn-xs"><fmt:message key="配置热搜词" /></button>';
			}
		}]
	});
	...
	var configItemTable = $("table#configItemTable").DataTable({
		...
		{	"title" : "ID",
			...
			"title" : '<center>热搜词名称</center>',
			"data" : "name",
			"width" : "200px",
			"className": "text-center",
			"orderable" : true
		}, {
			"title" : '<center>热搜词英文名</center>',
			"data" : "code",
			"width" : "200px",
			"className": "text-center",
			"orderable" : false
		}, {
			"title" : '<center>热搜词排序值</center>',
			"data" : "value",
			"width" : "60px",
			"className": "text-center",
			"orderable" : true
...
<body>
<div class="row">
  <div class="col-md-10"><h3>热搜词配置</h3></div>
...
<div class="row">
  <div class="col-md-2"><h4>热搜词维护</h4></div>
</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">热搜词配置操作</h4>
			</div>
