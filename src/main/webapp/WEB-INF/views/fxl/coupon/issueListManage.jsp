	...
	var couponTable = $("table#couponTable").DataTable({
		...
		"columnDefs" : [{
			...
			"render" : function(data, type, full) {
				return '<button id="offsale" mId="' + full.DT_RowId + '" type="button" class="btn btn-success btn-xs">查看</button>';
			}
		}]
	});
...
<div class="row">
  <div class="col-md-8"><h3>客户领取活动维护</h3></div>
...
<div class="row">
  <div class="col-md-2"><h4>客户领取活动列表</h4></div>
  <div class="col-md-10"><p class="text-right"><button id="createEventBtn" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> 创建客户领取活动</button>
