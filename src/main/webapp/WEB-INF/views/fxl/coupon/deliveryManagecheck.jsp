	...
	var couponTable = $("table#couponTable").DataTable({
		...
		"columnDefs" : [{
			...
			"render" : function(data, type, full) {
				var retString = '<button id="offsale" mId="' + full.DT_RowId + '" type="button" class="btn btn-success btn-xs">查看</button><br>';
				if(data.status == 10){
...
<div class="row">
  <div class="col-md-8"><h3>定向投放活动审核</h3></div>
