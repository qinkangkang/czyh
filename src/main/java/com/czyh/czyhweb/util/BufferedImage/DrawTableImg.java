package com.czyh.czyhweb.util.BufferedImage;
	...
	public static void myGraphicsGeneration(String cellsValue[][], String path) {
		...
		for (int j = 0; j < totalrow; j++) {
			...
			if(j==0){
				...
				graphics.drawLine(startWidth, startHeight+(j + 1) * rowheight-20, startWidth + colwidth * totalcol,
						startHeight+(j + 1) * rowheight-20);
			}else{
				graphics.setColor(color);
