...
public class DictionaryUtil {
	...
	// 优惠券使用终端
	public static final long czyhwebModule = 55;

	// 栏目类型
	public static final long ChannelType = 56;

	// 公告类别
	public static final long czyhwebNotice = 57;
	...
	// 嘉年华活动状态
	public static final long CarnivalStatus = 76;

	// 嘉年华凭证
	public static final long CarnivalrCredentia = 77;

	// 嘉年华奖品等级
	public static final long CarnivalPrize = 78;
	...
	// 邀请有礼
	public static final long SadelsModel = 92;

	// 推送跳转固定模块
	public static final long PushSadelsModel = 93;

	// app启动图跳转
	public static final long AppStartUrlType = 94;
	...
	// 支付通道
	public static final long Paychannel= 100;
