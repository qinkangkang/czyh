 ...
 * "http://mp.weixin.qq.com/wiki/7/aaa137b55fb2e0456bf8dd9148dd613f.html#.E6.AD.A5.E9.AA.A4.E4.B8.89.EF.BC.9A.E9.80.9A.E8.BF.87config.E6.8E.A5.E5.8F.A3.E6.B3.A8.E5.85.A5.E6.9D.83.E9.99.90.E9.AA.8C.E8.AF.81.E9.85.8D.E7.BD.AE">微信JSSDK说明文档↗</a>
 *
...
public class JSSDKConfig extends HttpServlet {
	 ...
	 * /wxpay.properties 读取
	 */
	public String getAppid(HttpServletRequest req) throws Exception {
		return (this.appid);
	}
	 ...
	 * @see com.github.cuter44.wxpay.TokenKeeper
	 */
	public void ifAcceptURL(String url) throws Exception {
		return;
	}
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		try {
			...
			String signature = this.crypto.bytesToHex(this.crypto.SHA1Digest(ub.toString().getBytes("utf-8")));
