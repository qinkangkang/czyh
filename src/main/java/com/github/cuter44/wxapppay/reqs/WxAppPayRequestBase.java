package com.github.cuter44.wxapppay.reqs;
...
import com.github.cuter44.wxapppay.resps.WxAppPayResponseBase;
 ...
 * @date 2014/12/25
 */
public abstract class WxAppPayRequestBase {
	 ...
	 * @return this
	 */
	public WxAppPayRequestBase configHC(SSLContext ctx) {
	...
	// CONSTRUCT
	public WxAppPayRequestBase(Properties aConf) {
		this.conf = aConf;
	 ...
	 * chain supported
	 */
	public WxAppPayRequestBase setProperty(String key, String value) {
	 ...
	 */
	public WxAppPayRequestBase setProperties(Map aConf) {
		this.conf.putAll(aConf);
		return (this);
	}

	// BUILD
	public abstract WxAppPayRequestBase build();
	 ...
	 *                algorithm) not found
	 */
	public abstract WxAppPayRequestBase sign()
	 ...
	 */
	public abstract WxAppPayResponseBase execute() throws WxpayException, WxpayProtocolException, IOException;
	...
	// MISC
	public WxAppPayRequestBase setAppid(String appid) {
		this.setProperty(KEY_APPID, appid);

		return (this);
	}

	public WxAppPayRequestBase setNonceStr(String nonceStr) {
