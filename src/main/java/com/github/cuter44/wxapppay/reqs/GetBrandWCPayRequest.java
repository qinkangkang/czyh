...
public class GetBrandWCPayRequest extends WxAppPayRequestBase {
	...
	// EXECUTE
	@Override
	public WxAppPayResponseBase execute() {
	 ...
	 */
	public WxAppPayRequestBase setTimeStamp(Date timeStamp) {
	 ...
	 */
	public WxAppPayRequestBase setSignType(String signType) {
	 ...
	 */
	public WxAppPayRequestBase setPackage(String paxkage) {
