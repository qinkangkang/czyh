...
import com.github.cuter44.wxh5pay.util.XMLParser;
 ...
 */
public class WxAppPayResponseBase {
	// CONSTANTS
	 ...
	 */
	public WxAppPayResponseBase(String xml) throws WxpayProtocolException, WxpayException {
		this.respString = xml;
	 ...
	 * defined to cope with that.
	 */
	public WxAppPayResponseBase(InputStream xml) throws IOException {
		this.respProp = XMLParser.parseXML(xml);
	 ...
	 */
	public WxAppPayResponseBase(Properties aRespProp) {
		this(null, aRespProp);
	 ...
	 * @deprecated due to it doesn't parse and detect fails. ONLY FOR DEBUGGING.
	 */
	public WxAppPayResponseBase(String aRespString, Properties aRespProp) {
	...
	protected static List<String> materializeParamNames(String template, int level, Integer count0) {
		...
		return (Arrays.asList(WxAppPayResponseBase.internalMaterializeParamNames(template, level, count0)));
	}
	...
	protected static List<String> materializeParamNames(String template, int level, Integer count0, List... counts) {
		...
		String[] m0 = WxAppPayResponseBase.internalMaterializeParamNames(template, level, count0);
		List<String> mx;
